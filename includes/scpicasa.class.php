...
class SCPicasa
{
    ...
    function get_gallery_images( $attr = array() ){
        ...
        global $socialcast, $scpicasa, $post;
            ...
            <dl class="gallery-item">
                <dt class="gallery-icon">
					<a href="'.$urlimgori.'" title="'.$title.'" rel="lightbox-" target="_blank">
						<img src="'.$socialcast->plugin_url.'/includes/timthumb.php?src='.$urlimg.'&amp;w='.$width.'&amp;h='.$height.'&amp;zc=1&amp;q=90" alt="Picasa Gallery" class="sc-image" width="'.$width.'" height="'.$height.'"/>
