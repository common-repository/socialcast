...
$scflickrIncludePath = get_include_path().PATH_SEPARATOR. $socialcast->plugin_path .'/includes/flickr/';
...
class SCFlickr
{
	...
	{
		$this->admin_page = add_submenu_page('socialcast', __( 'Flickr Settings', 'socialcast' ), __( 'Flickr Settings', 'socialcast' ), 'manage_options', $this->token, array( &$this, 'handleOptions' ) );
    ...
    function get_gallery_images($attr = array()) {
        ...
        global $socialcast, $SCFlickr, $post;
            ...
            <dl class="gallery-item">
                <dt class="gallery-icon">
					<a href="'.$urlimgori.'" title="'.$photo['title'].'" rel="lightbox-" target="_blank">
						<img src="'.$socialcast->plugin_url.'/includes/timthumb.php?src='.$urlimg.'&amp;w='.$width.'&amp;h='.$height.'&amp;zc=1&amp;q=90" alt="Flickr Gallery" class="sc-image" width="'.$width.'" height="'.$height.'"/>
					</a>
                </dt>
            </dl>';
