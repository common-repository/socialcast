...
class SCPinterest
{
    ...
    function get_gallery_images( $attr = array() ){
        ...
        global $socialcast, $scpinterest, $post;
                ...
                <dl class="gallery-item">
                    <dt class="gallery-icon">
    					<a href="'.str_ireplace('_b.jpg','_c.jpg',$src).'" title="'.$pin_caption.'" rel="lightbox-" target="_blank">
    						<img src="'.$socialcast->plugin_url.'/includes/timthumb.php?src='.$src.'&amp;w='.$width.'&amp;h='.$height.'&amp;zc=1&amp;q=90" alt="Pinterest Gallery" class="sc-image" width="'.$width.'" height="'.$height.'"/>
    					</a>
                    </dt>
                </dl>';
